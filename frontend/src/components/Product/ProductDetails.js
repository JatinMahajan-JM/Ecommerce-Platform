      ...
      <div className="ProductDetails">
        <div className="auto-center">
          ...
          {product.images &&
            product.images.map(
              (item, i) =>
                (<img className="CarouselImage" key={item.url} alt={`${i} Slide`} src={require(`../../images/${item.public_id}.jpg`)}/>)
            )}
          </Carousel>
        </div>
          ...
          <div className="detailsBlock-3">
            ...
            <div className="detailsBlock-3-1">
              <div className="detailsBlock-3-1-1">
                ...
                <input readOnly type="number" value={quantity} className="newinput" placeholder=""/>
